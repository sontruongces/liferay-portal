			...
			<aui:fieldset>
				<aui:field-wrapper>
					<div class="alert alert-info">
						<liferay-ui:message arguments="<%= HtmlUtil.escape(StringUtil.merge(kbGroupServiceOverriddenConfiguration.markdownImporterArticleExtensions(), StringPool.COMMA_AND_SPACE)) %>" key="upload-your-zip-file-help" />
					</div>
				</aui:field-wrapper>
