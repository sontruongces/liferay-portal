...
public abstract class BaseTeamRoleResourceTestCase {
		...
		testGetTeamRolesPageWithSort(
			...
			(entityField, teamRole1, teamRole2) -> {
				...
				if (returnType.isAssignableFrom(Map.class)) {
					...
					BeanUtils.setProperty(
						teamRole2, entityField.getName(),
						Collections.singletonMap("Bbb", "Bbb"));
				}
				else {
					BeanUtils.setProperty(
						teamRole1, entityField.getName(), "Aaa");
					BeanUtils.setProperty(
						teamRole2, entityField.getName(), "Bbb");
				}
			});
	}
	...
	public void testGraphQLDeleteTeamRole() throws Exception {
		TeamRole teamRole = testGraphQLTeamRole_addTeamRole();
		...
		Assert.assertTrue(dataJSONObject.getBoolean("deleteTeamRole"));
