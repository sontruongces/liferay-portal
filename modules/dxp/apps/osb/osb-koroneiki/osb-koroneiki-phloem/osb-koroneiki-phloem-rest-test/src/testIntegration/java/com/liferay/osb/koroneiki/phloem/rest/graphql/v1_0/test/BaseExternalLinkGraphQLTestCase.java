 ...
 */
@Generated("")
public abstract class BaseExternalLinkGraphQLTestCase {
	...
	protected boolean equals(ExternalLink externalLink, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			...
			if (Objects.equals("entityId", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("entityId"))) {
			...
			if (Objects.equals("entityName", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("entityName"))) {
