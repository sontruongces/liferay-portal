 ...
 */
@Generated("")
public abstract class BaseContactGraphQLTestCase {
	...
	protected boolean equals(Contact contact, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			...
			if (Objects.equals("firstName", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("firstName"))) {
			...
			if (Objects.equals("languageId", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("languageId"))) {
			...
			if (Objects.equals("middleName", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("middleName"))) {
			...
			if (Objects.equals("oktaId", fieldName)) {
				if (!Objects.equals(
						contact.getOktaId(),
						(String)jsonObject.getString("oktaId"))) {
