 ...
 */
@Generated("")
public abstract class BaseContactRoleGraphQLTestCase {
	...
	protected boolean equals(ContactRole contactRole, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			...
			if (Objects.equals("system", fieldName)) {
				if (!Objects.equals(
						...
						(Boolean)jsonObject.getBoolean("system"))) {
