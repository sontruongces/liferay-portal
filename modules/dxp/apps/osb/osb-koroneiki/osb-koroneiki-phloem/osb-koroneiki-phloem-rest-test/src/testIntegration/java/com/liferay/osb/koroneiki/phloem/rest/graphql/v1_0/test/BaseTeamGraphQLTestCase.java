 ...
 */
@Generated("")
public abstract class BaseTeamGraphQLTestCase {
	...
	protected boolean equals(Team team, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			if (Objects.equals("accountKey", fieldName)) {
				if (!Objects.equals(
						team.getAccountKey(),
						(String)jsonObject.getString("accountKey"))) {
			...
			if (Objects.equals("key", fieldName)) {
				if (!Objects.equals(
						team.getKey(), (String)jsonObject.getString("key"))) {
			...
			if (Objects.equals("name", fieldName)) {
				if (!Objects.equals(
						team.getName(), (String)jsonObject.getString("name"))) {
