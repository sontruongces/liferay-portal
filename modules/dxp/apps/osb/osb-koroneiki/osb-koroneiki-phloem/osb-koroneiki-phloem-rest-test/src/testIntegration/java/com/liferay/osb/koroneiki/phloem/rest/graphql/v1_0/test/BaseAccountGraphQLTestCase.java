 ...
 */
@Generated("")
public abstract class BaseAccountGraphQLTestCase {
	...
	protected boolean equals(Account account, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			...
			if (Objects.equals("contactEmailAddress", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("contactEmailAddress"))) {
			...
			if (Objects.equals("faxNumber", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("faxNumber"))) {
			...
			if (Objects.equals("logoId", fieldName)) {
				if (!Objects.equals(
						account.getLogoId(),
						(Long)jsonObject.getLong("logoId"))) {
			...
			if (Objects.equals("parentAccountKey", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("parentAccountKey"))) {
			...
			if (Objects.equals("profileEmailAddress", fieldName)) {
				if (!Objects.equals(
						...
						(String)jsonObject.getString("profileEmailAddress"))) {
			...
			if (Objects.equals("soldBy", fieldName)) {
				if (!Objects.equals(
						account.getSoldBy(),
						(String)jsonObject.getString("soldBy"))) {
