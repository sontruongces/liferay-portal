...
public abstract class BaseProductResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/koroneiki-rest/v1.0/products/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/koroneiki-rest/v1.0/products/{productKey}/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes("application/json")
	@DELETE
	...
	@Path("/products/{productKey}/batch")
	@Produces("application/json")
	@Tags(value = {@Tag(name = "Product")})
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/koroneiki-rest/v1.0/products/{productKey}/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes("application/json")
	@PUT
	...
	public void update(
		...
		for (Product product : products) {
			putProduct(agentName, agentUID, productKey, product);
		}
	}
