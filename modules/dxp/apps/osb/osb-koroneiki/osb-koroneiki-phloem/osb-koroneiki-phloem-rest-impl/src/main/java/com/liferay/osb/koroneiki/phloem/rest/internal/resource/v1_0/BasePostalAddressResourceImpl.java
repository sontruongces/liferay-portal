...
public abstract class BasePostalAddressResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/koroneiki-rest/v1.0/postal-addresses/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/koroneiki-rest/v1.0/postal-addresses/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes("application/json")
	@PUT
	...
	public void update(
		...
		for (PostalAddress postalAddress : postalAddresses) {
			putPostalAddress(
				...
				(Long)parameters.get("postalAddressId"),
				postalAddress);
		}
	}
