...
@Generated("")
@Path("/v1.0")
public abstract class BaseAuditEntryResourceImpl
	implements AuditEntryResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<AuditEntry> {
	...
	public void create(
			java.util.Collection<AuditEntry> auditEntries,
