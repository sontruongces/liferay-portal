...
public class ProductConsumption {
	...
	@Schema(description = "The ID of the account consuming the product.")
	...
	@Schema(description = "The ID of the product being consumed.")
	...
	@Schema(description = "The ID of the project consuming the product.")
