...
public class EntitlementDefinitionPersistenceImpl
	...
	public EntitlementDefinition fetchByC_N(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_N_CLASSNAMEID_2);
	...
	public EntitlementDefinition remove(Serializable primaryKey)
		...
		catch (NoSuchEntitlementDefinitionException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<EntitlementDefinition> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_ENTITLEMENTDEFINITION);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_ENTITLEMENTDEFINITION);
