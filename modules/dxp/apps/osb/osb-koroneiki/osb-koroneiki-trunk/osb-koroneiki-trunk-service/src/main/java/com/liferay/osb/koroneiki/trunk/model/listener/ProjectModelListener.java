...
public class ProjectModelListener extends BaseModelListener<Project> {

	@Override
	public void onAfterRemove(Project project) throws ModelListenerException {
		try {

			// Product consumptions

			List<ProductConsumption> productConsumptions =
				_productConsumptionLocalService.getProjectProductConsumptions(
					project.getProjectId(), QueryUtil.ALL_POS,
					QueryUtil.ALL_POS);
