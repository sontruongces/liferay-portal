...
public class ProductPurchasePersistenceImpl
	...
	private static final String _FINDER_COLUMN_ACCOUNTID_ACCOUNTID_2 =
		"productPurchase.accountId = ? AND productPurchase.projectId = 0";
	 ...
	 */
	@Override
	public List<ProductPurchase> findByProjectId(long projectId) {
	 ...
	 */
	@Override
	public List<ProductPurchase> findByProjectId(
	...
	public List<ProductPurchase> findByProjectId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ProductPurchase productPurchase : list) {
					if ((projectId != productPurchase.getProjectId())) {
						list = null;
	 ...
	 */
	@Override
	public ProductPurchase findByProjectId_First(
			long projectId,
			OrderByComparator<ProductPurchase> orderByComparator)
		throws NoSuchProductPurchaseException {

		ProductPurchase productPurchase = fetchByProjectId_First(
	 ...
	 */
	@Override
	public ProductPurchase fetchByProjectId_First(
		long projectId, OrderByComparator<ProductPurchase> orderByComparator) {

		List<ProductPurchase> list = findByProjectId(
	 ...
	 */
	@Override
	public ProductPurchase findByProjectId_Last(
			long projectId,
			OrderByComparator<ProductPurchase> orderByComparator)
		throws NoSuchProductPurchaseException {

		ProductPurchase productPurchase = fetchByProjectId_Last(
			projectId, orderByComparator);
	 ...
	 */
	@Override
	public ProductPurchase fetchByProjectId_Last(
		long projectId, OrderByComparator<ProductPurchase> orderByComparator) {
	 ...
	 */
	@Override
	public ProductPurchase[] findByProjectId_PrevAndNext(
		...
		try {
			...
			array[0] = getByProjectId_PrevAndNext(
				session, productPurchase, projectId, orderByComparator, true);

			array[1] = productPurchase;

			array[2] = getByProjectId_PrevAndNext(
				session, productPurchase, projectId, orderByComparator, false);
	...
	protected ProductPurchase getByProjectId_PrevAndNext(
		Session session, ProductPurchase productPurchase, long projectId,
		OrderByComparator<ProductPurchase> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<ProductPurchase> filterFindByProjectId(long projectId) {
	 ...
	 */
	@Override
	public List<ProductPurchase> filterFindByProjectId(
		long projectId, int start, int end) {
	 ...
	 */
	@Override
	public ProductPurchase[] filterFindByProjectId_PrevAndNext(
			long productPurchaseId, long projectId,
			OrderByComparator<ProductPurchase> orderByComparator)
		throws NoSuchProductPurchaseException {
	...
	protected ProductPurchase filterGetByProjectId_PrevAndNext(
		Session session, ProductPurchase productPurchase, long projectId,
		OrderByComparator<ProductPurchase> orderByComparator,
		boolean previous) {
	...
	public ProductPurchase create(long productPurchaseId) {
		...
		productPurchase.setCompanyId(companyProvider.getCompanyId());
	...
	public ProductPurchase updateImpl(ProductPurchase productPurchase) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {productPurchaseModelImpl.getProjectId()};
			...
			if ((productPurchaseModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					productPurchaseModelImpl.getOriginalProjectId()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByProjectId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			ProductPurchaseModelImpl.PROJECTID_COLUMN_BITMASK);
