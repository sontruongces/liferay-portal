...
<liferay-ui:search-container
	emptyResultsMessage="no-product-consumption-was-found"
	headerNames="name,"
	iteratorURL="<%= portletURL %>"
	total="<%= ProductConsumptionLocalServiceUtil.getProductConsumptionsCount() %>"
>
	<liferay-ui:search-container-results
		results="<%= ProductConsumptionLocalServiceUtil.getProductConsumptions(searchContainer.getStart(), searchContainer.getEnd()) %>"
	/>
