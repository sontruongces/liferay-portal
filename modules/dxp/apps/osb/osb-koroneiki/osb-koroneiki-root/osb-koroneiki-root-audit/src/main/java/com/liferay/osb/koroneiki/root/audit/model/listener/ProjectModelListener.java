...
public class ProjectModelListener extends BaseAuditModelListener<Project> {

	@Override
	protected long getClassNameId(Project project) {
		return classNameLocalService.getClassNameId(Account.class);
	}

	@Override
	protected long getClassPK(Project project) {
		return project.getAccountId();
	}

	@Override
	protected Project getModel(long classPK) throws PortalException {
		return _projectLocalService.getProject(classPK);
	}
