...
/**
 * Provides the base implementation for the team project role remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectRoleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectRoleServiceImpl
 * @generated
 */
public abstract class TeamProjectRoleServiceBaseImpl
	extends BaseServiceImpl
	implements TeamProjectRoleService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TeamProjectRoleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.osb.koroneiki.taproot.service.TeamProjectRoleServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TeamProjectRoleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		teamProjectRoleService = (TeamProjectRoleService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TeamProjectRoleService.class.getName();
	}
	...
	@Reference
	protected
		com.liferay.osb.koroneiki.taproot.service.TeamProjectRoleLocalService
			teamProjectRoleLocalService;

	protected TeamProjectRoleService teamProjectRoleService;
