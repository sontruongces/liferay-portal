...
import com.liferay.osb.koroneiki.taproot.service.TeamProjectRoleLocalService;
...
/**
 * Provides the base implementation for the team project role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectRoleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectRoleLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class TeamProjectRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TeamProjectRoleLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TeamProjectRoleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.osb.koroneiki.taproot.service.TeamProjectRoleLocalServiceUtil</code>.
	 */
	...
	public TeamProjectRole addTeamProjectRole(TeamProjectRole teamProjectRole) {
		...
		return teamProjectRolePersistence.update(teamProjectRole);
	}
	...
	public TeamProjectRole createTeamProjectRole(
		...
		return teamProjectRolePersistence.create(teamProjectRolePK);
	}
	...
	public TeamProjectRole deleteTeamProjectRole(
		...
		return teamProjectRolePersistence.remove(teamProjectRolePK);
	}
	...
	public TeamProjectRole deleteTeamProjectRole(
		...
		return teamProjectRolePersistence.remove(teamProjectRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TeamProjectRole.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return teamProjectRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return teamProjectRolePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return teamProjectRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return teamProjectRolePersistence.countWithDynamicQuery(
	...
	public TeamProjectRole fetchTeamProjectRole(
		...
		return teamProjectRolePersistence.fetchByPrimaryKey(teamProjectRolePK);
	}
	...
	public TeamProjectRole getTeamProjectRole(
		...
		return teamProjectRolePersistence.findByPrimaryKey(teamProjectRolePK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(teamProjectRoleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TeamProjectRole.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			teamProjectRoleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TeamProjectRole.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return teamProjectRoleLocalService.deleteTeamProjectRole(
			(TeamProjectRole)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return teamProjectRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TeamProjectRole> getTeamProjectRoles(int start, int end) {
		return teamProjectRolePersistence.findAll(start, end);
	}
	...
	public int getTeamProjectRolesCount() {
		return teamProjectRolePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TeamProjectRoleLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		teamProjectRoleLocalService = (TeamProjectRoleLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TeamProjectRoleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = teamProjectRolePersistence.getDataSource();
	...
	protected TeamProjectRoleLocalService teamProjectRoleLocalService;
