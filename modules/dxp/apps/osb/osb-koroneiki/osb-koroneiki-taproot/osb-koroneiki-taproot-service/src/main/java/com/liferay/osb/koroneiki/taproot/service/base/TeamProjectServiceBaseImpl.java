...
import com.liferay.osb.koroneiki.taproot.service.TeamProjectService;
...
/**
 * Provides the base implementation for the team project remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectServiceImpl
 * @generated
 */
public abstract class TeamProjectServiceBaseImpl
	extends BaseServiceImpl
	implements TeamProjectService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TeamProjectService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.osb.koroneiki.taproot.service.TeamProjectServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TeamProjectService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		teamProjectService = (TeamProjectService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TeamProjectService.class.getName();
	}
	...
	@Reference
	protected com.liferay.osb.koroneiki.taproot.service.TeamProjectLocalService
		teamProjectLocalService;

	protected TeamProjectService teamProjectService;
