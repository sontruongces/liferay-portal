...
/**
 * Provides the local service interface for ContactProjectRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContactProjectRoleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ContactProjectRoleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContactProjectRoleLocalServiceUtil} to access the contact project role local service. Add custom service methods to <code>com.liferay.osb.koroneiki.taproot.service.impl.ContactProjectRoleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
