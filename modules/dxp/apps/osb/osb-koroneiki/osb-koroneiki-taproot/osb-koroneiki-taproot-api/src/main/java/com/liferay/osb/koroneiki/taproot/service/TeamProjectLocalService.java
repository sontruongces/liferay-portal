...
/**
 * Provides the local service interface for TeamProject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TeamProjectLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TeamProjectLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TeamProjectLocalServiceUtil} to access the team project local service. Add custom service methods to <code>com.liferay.osb.koroneiki.taproot.service.impl.TeamProjectLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public TeamProject addTeamProject(long teamId, long projectId);
