...
page import="com.liferay.osb.koroneiki.taproot.constants.ContactRoleSystem" %><%@
page import="com.liferay.osb.koroneiki.taproot.constants.ContactRoleType" %><%@
page import="com.liferay.osb.koroneiki.taproot.constants.ProjectIndustry" %><%@
page import="com.liferay.osb.koroneiki.taproot.constants.ProjectTier" %><%@
