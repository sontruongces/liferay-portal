...
<portlet:actionURL name="/projects_admin/assign_project_team_roles" var="assignProjectTeamRolesURL" />

<div class="main-content-body">
	<aui:form action="<%= assignProjectTeamRolesURL %>" cssClass="container-fluid-1280" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "submitForm();" %>'>
		...
		<liferay-ui:search-container
			...
			total="<%= TeamRoleLocalServiceUtil.getTeamRolesCount(TeamRoleType.PROJECT) %>"
		>
			<liferay-ui:search-container-results
				results="<%= TeamRoleLocalServiceUtil.getTeamRoles(TeamRoleType.PROJECT, searchContainer.getStart(), searchContainer.getEnd()) %>"
			/>
