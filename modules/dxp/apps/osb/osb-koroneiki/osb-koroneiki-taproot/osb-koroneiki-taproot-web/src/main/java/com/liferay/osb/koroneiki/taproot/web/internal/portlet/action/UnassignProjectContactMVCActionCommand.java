...
@Component(
	property = {
		...
		"mvc.command.name=/projects_admin/unassign_project_contact"
	},
	service = MVCActionCommand.class
)
public class UnassignProjectContactMVCActionCommand
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UnassignProjectContactMVCActionCommand.class);
