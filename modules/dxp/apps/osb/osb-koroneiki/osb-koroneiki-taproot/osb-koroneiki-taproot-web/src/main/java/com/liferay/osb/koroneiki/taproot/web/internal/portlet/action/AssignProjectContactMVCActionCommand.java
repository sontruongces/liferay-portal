...
@Component(
	property = {
		...
		"mvc.command.name=/projects_admin/assign_project_contact"
	},
	service = MVCActionCommand.class
)
public class AssignProjectContactMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		try {
			...
			_contactProjectRoleService.addContactProjectRole(
				contact.getContactId(), projectId,
			...
			if (e instanceof NoSuchContactException) {
				ResourceBundle resourceBundle = ResourceBundleUtil.getBundle(
					...
					AssignProjectContactMVCActionCommand.class);
