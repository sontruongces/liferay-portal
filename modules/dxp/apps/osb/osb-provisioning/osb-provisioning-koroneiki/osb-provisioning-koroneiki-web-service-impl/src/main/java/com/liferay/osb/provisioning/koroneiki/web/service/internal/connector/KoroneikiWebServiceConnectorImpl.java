...
package com.liferay.osb.provisioning.koroneiki.web.service.internal.connector;
 ...
 */
@Component(
	immediate = true, property = {"api.token=", "host=", "port=", "protocol="},
	service = KoroneikiWebServiceConnector.class
)
public class KoroneikiWebServiceConnectorImpl
	implements KoroneikiWebServiceConnector {
